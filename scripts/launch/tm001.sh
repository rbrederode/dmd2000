...
RUN_CMD='cd "$HOME/github/alston-rt/src" && python tm/tm.py --entity_id tm001 --dig_host 192.168.0.7 --sdp_host 192.168.0.7 --dm_host 192.168.0.7 --ws_host 192.168.0.18; exec bash'
...
tell application "Terminal"
    activate
    do script "cd \"$SESSION_DIR\" && python tm/tm.py --entity_id tm001 --dig_host 192.168.0.7 --sdp_host 192.168.0.7 --dm_host 192.168.0.7 --ws_host 192.168.0.18; exec bash"
end tell
EOF
else
