...
RUN_CMD='cd "$HOME/github/alston-rt/src" && python dsh/dm.py --entity_id dm001 --tm_host 192.168.0.7 --ws_host 192.168.0.7; exec bash'
...
tell application "Terminal"
    activate
    do script "cd \"$SESSION_DIR\" && python dsh/dm.py --entity_id dm001 --tm_host 192.168.0.7 --ws_host 192.168.0.7; exec bash"
end tell
EOF
else
