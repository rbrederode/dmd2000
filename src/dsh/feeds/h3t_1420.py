...
class H3T_1420Config(BaseModel):
    """A class representing the configuration for an H3T-1420 dish feed."""

    schema = Schema({      
        "_type": And(str, lambda v: v == "H3T_1420Config"),
