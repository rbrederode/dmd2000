...
RUN_CMD='cd "$HOME/github/alston-rt/src" && python tm/tm.py --profile local --entity_id tm001 --dig_host 127.0.0.1 --sdp_host 127.0.0.1 --dm_host 127.0.0.1 --ws_host 127.0.0.1; exec bash'
...
tell application "Terminal"
    activate
    do script "cd \"$SESSION_DIR\" && python tm/tm.py --profile local --entity_id tm001 --dig_host 127.0.0.1 --sdp_host 127.0.0.1 --dm_host 127.0.0.1 --ws_host 127.0.0.1; exec bash"
end tell
EOF
else
