...
RUN_CMD='cd "$HOME/github/alston-rt/src" && python dsh/drivers/md01/md01_simulator.py --host 127.0.0.1; exec bash'
...
tell application "Terminal"
    activate
    do script "cd \"$SESSION_DIR\" && python dsh/drivers/md01/md01_simulator.py --host 127.0.0.1; exec bash"
end tell
EOF
else
