...
RUN_CMD='cd "$HOME/github/alston-rt/src" && export GPIOZERO_PIN_FACTORY=mock && python dig/dig.py --profile local --entity_id dig003 --tm_host 127.0.0.1 --sdp_host 127.0.0.1 --local_host 127.0.0.1; exec bash'
